                ...
                <v-table>
                    ...
                    <tbody>
                        ...
                        >
                            ...
                            <td class="whitespace-nowrap" label="RegistrationDate">{{ val.registrationDate }}</td>
                            <td class="whitespace-nowrap" label="PublicationDate">{{ val.publicationDate }}</td>
                            <td class="whitespace-nowrap" label="NumberOfSubscribers">{{ val.numberOfSubscribers }}</td>
                ...
                <v-card>
                    ...
                    <v-card-text>
                        <div>
                            ...
                            <Date label="RegistrationDate" v-model="selectedRow.registrationDate" :editMode="true"/>
                            <Date label="PublicationDate" v-model="selectedRow.publicationDate" :editMode="true"/>
                            <Number label="NumberOfSubscribers" v-model="selectedRow.numberOfSubscribers" :editMode="true"/>
                            <String label="publicationID" v-model="selectedRow.publicationId" :editMode="true"/>
